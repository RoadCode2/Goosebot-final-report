...
# --- CONFIGURATION ---
MODEL_PATH = '/home/radxa/nmslim_rknn_model'
CAMERA_WIDTH = 640
CAMERA_HEIGHT = 480
...
#setup 1: BASE_SPEED = 0.14
BASE_SPEED = 0.10       
LANE_WIDTH_PIXELS = 450

# STOP SIGN LOGIC
STOP_DURATION = 0        
STOP_COOLDOWN = 10000000.0        
STOP_THRESHOLD_Y = 1000000000000 

# MOTOR PHYSICS
MIN_MOTOR_POWER = 0.070   
MAX_STEER = 0.55          
...
def robot_control_loop():
    ...
    try:
        ...
        pca = PCA9685(i2c)
        pca.frequency = 100
        left_motors = [Motor(pca, 7, 6), Motor(pca, 3, 2)]
        right_motors = [Motor(pca, 5, 4), Motor(pca, 1, 0)]
    ...
    try:
        ...
        while True:
            ...
            # iou=0.45 is the standard default; lower values (e.g., 0.3) are more aggressive at removing overlaps
            results = model.predict(source=frame, conf=0.28, iou=0.2, imgsz=640, verbose=False) #setup1: 0.18 conf
            result = results[0]
            boxes = result.boxes
